...
import org.streamreasoning.rsp4j.yasper.querying.syntax.RSPQLExtractionHelper;
import org.streamreasoning.rsp4j.yasper.querying.syntax.SimpleRSPQLQuery;
import org.streamreasoning.rsp4j.yasper.querying.syntax.TripleHolder;
...
public class TPVisitorImpl extends RSPQLBaseVisitor<CQ> {
    ...
    public ContinuousQuery<Graph, Graph, Binding, Binding> generateQuery() {
        ...
        org.streamreasoning.rsp4j.yasper.querying.syntax.SimpleRSPQLQuery<Binding> query = new SimpleRSPQLQuery<>(windowIRI, stream, time, win, windowsToTriples, rstream, defaultGraphUri);
