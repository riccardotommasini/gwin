...
public class RSPQLVisitorImpl extends RSPQLBaseVisitor {
    ...
    public Object visitOutputStreamType(RSPQLParser.OutputStreamTypeContext ctx) {
        org.streamreasoning.rsp4j.yasper.querying.syntax.RSPQLExtractionHelper.setOutputStreamType(query, ctx.getText());
    ...
    public Object visitOutputStream(RSPQLParser.OutputStreamContext ctx) {
        String iri = org.streamreasoning.rsp4j.yasper.querying.syntax.RSPQLExtractionHelper.extractOutputStream(ctx);
